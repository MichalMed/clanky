...
% přidání kontextu (datasetů, užití) -- přišlo se na to, že některé property mají smysl pouze v určitém kontextu -- celý dataset oanotovat

% rozdělení na více ontologií a jejich popis

% common, all a appendix
...
% dotazy na konrétní data 

% převod konkrétního dotazu na SparQL

% zjištění kontextu konkrétního dotazu
